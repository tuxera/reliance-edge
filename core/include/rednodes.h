...
/** Compile-time boolean which corresponds to REDCONF_API_POSIX == 1. */
#define MBFLAG_API_POSIX        (0x01U)

/** Compile-time boolean which corresponds to REDCONF_INODE_TIMESTAMPS == 1. */
#define MBFLAG_INODE_TIMESTAMPS (0x02U)

/** Compile-time boolean which corresponds to REDCONF_INODE_BLOCKS == 1. */
#define MBFLAG_INODE_BLOCKS     (0x04U)

/** Compile-time boolean which corresponds to REDCONF_API_POSIX == REDCONF_API_POSIX_LINK == 1. */
