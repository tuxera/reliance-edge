...
$(P_BASEDIR)/os/win32/tools/imgbld/ibcommon.obj:	$(P_BASEDIR)/os/win32/tools/imgbld/ibcommon.c $(IMGBLDHDR)
$(P_BASEDIR)/os/win32/tools/imgbld/ibfse.obj:		$(P_BASEDIR)/os/win32/tools/imgbld/ibfse.c $(IMGBLDHDR)
$(P_BASEDIR)/os/win32/tools/imgbld/ibposix.obj:		$(P_BASEDIR)/os/win32/tools/imgbld/ibposix.c $(IMGBLDHDR)
$(P_BASEDIR)/os/win32/tools/imgbld/imgbld.obj:		$(P_BASEDIR)/os/win32/tools/imgbld/imgbld.c $(IMGBLDHDR)
$(P_BASEDIR)/os/win32/tools/winfmt.obj:			$(P_BASEDIR)/os/win32/tools/winfmt.c $(P_BASEDIR)/os/win32/tools/wintlcmn.h
$(P_BASEDIR)/os/win32/tools/wintlcmn.obj:		$(P_BASEDIR)/os/win32/tools/wintlcmn.c  $(P_BASEDIR)/os/win32/tools/wintlcmn.h
