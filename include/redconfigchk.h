...
#define REDCONFIGCHK_H
  ...
  #if (REDCONF_NAME_MAX < 1) || (REDCONF_NAME_MAX > (REDCONF_BLOCK_SIZE - 4))
...
#elif REDCONF_API_POSIX == 0
  #if REDCONF_API_FSE != 1
    #error "Configuration error: REDCONF_API_FSE must be 1 if REDCONF_API_POSIX is 0"
  #endif
