...
*/
#define RED_BUILD_NUMBER "329"

/** @brief Date of the last automated build.

    <!-- This macro is updated automatically: do not edit! -->
*/
#define RED_BUILD_DATE "04/29/15"

/** @brief Time of the last automated build.

    <!-- This macro is updated automatically: do not edit! -->
*/
#define RED_BUILD_TIME "16:53:33"
