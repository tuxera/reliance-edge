...
void LimitReporter::updateLimits()
{
    ...
    qulonglong inodeDataBlocks =
            indirEntries * static_cast<qulonglong>(indirPointers)   // Inode indir blocks
            + indirEntries * indirEntries                           // Dindir data blocks
            + doubleIndirs * indirEntries * indirEntries;           // Inode Dindir blocks
