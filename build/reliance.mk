...
REDHDR=							\
	...
	$(P_BASEDIR)/os/$(P_OS)/include/ostypes.h	\
	$(P_PROJDIR)/redconf.h				\
...
REDCOREHDR=						\
	...
	$(P_BASEDIR)/core/include/redexclude.h		\
...
$(P_BASEDIR)/posix/path.$(B_OBJEXT):				$(P_BASEDIR)/posix/path.c $(REDHDR) $(P_BASEDIR)/posix/redposixutil.h
$(P_BASEDIR)/posix/posix.$(B_OBJEXT):				$(P_BASEDIR)/posix/posix.c $(REDHDR) $(P_BASEDIR)/posix/redposixutil.h
