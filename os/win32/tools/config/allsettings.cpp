...
static inline void addTrIfChecked(QString &outputString, BoolSetting *trSetting,
                                  bool override = true)
{
    if(override && trSetting->GetValue())
    {
...
const QString macroNameMemcpy = "RedMemCpy";
const QString macroNameMemmov = "RedMemMove";
const QString macroNameMemset = "RedMemSet";
const QString macroNameMemcmp = "RedMemCmp";
const QString macroNameStrlen = "RedStrLen";
const QString macroNameStrcmp = "RedStrCmp";
const QString macroNameStrncmp = "RedStrNCmp";
const QString macroNameStrncpy = "RedStrNCpy";
...
const QString cstdStrlen = "(uint32_t) strlen";
